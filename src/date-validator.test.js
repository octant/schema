...
describe("DateValidator", () => {
  ...
  const customMessageValidator = new DateValidator(
  ...
  test("returns an array of error messages for invalid values", () => {
    expect(validator.validate("2017-12-25", fields)).toEqual([
      "should be no earlier than 2018-01-01"
    ]);
    expect(validator.validate("2018-03-12", fields)).toEqual([
      "should be no later than 2018-02-28"
    ]);
  });
